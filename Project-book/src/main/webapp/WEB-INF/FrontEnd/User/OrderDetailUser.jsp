		 ...
		 <div class="container">
                    <div class=" m-auto">
                        <div class="py-3 my-3 row card-header ">
                            <div class="text-center"><strong>CHI TIẾT ĐƠN HÀNG </strong></div>
                        </div>
                        <div class="row p-0 bg-info text-white fs-5">
                            <div class="p-2 border col-1 text-center">STT</div>
                            <div class="p-2 border col-4 text-center">Tên sản phẩm</div>
                        ...
                        <c:forEach items="${orderDetailList }" var="orderDetail" varStatus="loop">
                            <div class="row p-0 justify-content-center align-items-center">
                                ...
                                <div class="p-2  col-4 text-center">${orderDetail.product.productName}</div>
                                <div class="p-2  col-3 text-center">${orderDetail.quantity} </div>
