...
<body>
				...
				<h3 style="color:red">${err}</h3>
					<form:form action="updateNews" method="post" runat="server" enctype="multipart/form-data" onsubmit="return FormValidate();" modelAttribute="news">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <form:input type="hidden" path="newsId" class="form-control border-secondary" id="newsId" name="newsId" />
                                        <form:input type="hidden" path="newsViews" class="form-control border-secondary" id="newsViews" name="newsViews" />
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <form:textarea maxlength = "300" type="text" path="newsDescription" class="form-control border-secondary" id="newsDescription" name="newsDescription"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <form:textarea maxlength = "2000" type="text" path="newsContent" class="form-control border-secondary" id="newsContent" name="newsContent"
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="productName">Ngày đăng</label>
                                            <%
                            ...
                            <div class="col-md-5 text-center">
                                ...
                                <h3 class = "py-4">Thay đổi hình ảnh</h3>
                                <div class="row">
                                	<div class="button-wrap">
                                	<label class="button" for="upload">Chọn 1 ảnh</label>
										<input id="upload" class = "mx-3" name = "newsImageName" type="file" accept="image/*" onchange="loadFile(event)">
