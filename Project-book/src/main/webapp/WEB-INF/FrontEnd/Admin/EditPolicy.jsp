...
<body>
				...
				<!-- edit contact-->
				<div class="col-md-9">
					<form:form action="admin-editPolicy"  method="post"
						 onsubmit="return FormValidate();"  modelAttribute="policy">
						<div class="row">
							<h2 class="text-center">Thay đổi chính sách</h2>
						</div>
						...
						<div class="row">
								<div class="form-group py-1">
									...
									<form:input  type="hidden" path="introduction" name="introduction" id="IntroductionContent" class="form-control" rows="10"></form:input>
								</div>
								<div class="form-group py-2">
									<label for="policy"><h5>Chính sách</h5></label>
									<form:textarea maxlength = "4000" path="policy" name="policy" id="policyContent" class="form-control" rows="10" ></form:textarea>
									<small class="text-danger" id="errPolicy"></small>
								</div>
	...
	<script type="text/javascript">
		function FormValidate() {
			var policy = document.getElementById('policyContent');
			
			var errPolicy = document.getElementById('errPolicy');
			
			if (policy == '' || policy == null) {
				errPolicy.innerHTML = "Vui lòng không để trống";
				return false;
			} else {
				errPolicy.innerHTML = '';
			}
	...
	maxLength(document.getElementById("policyContent"));
</script>
	<!-- validate form end-->
