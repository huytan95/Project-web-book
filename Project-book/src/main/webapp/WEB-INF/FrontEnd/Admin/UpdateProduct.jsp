...
<body>
				...
				<h3 style="color:red">${err}</h3>
					<form:form action="admin-updateProduct" method="post" runat="server" enctype="multipart/form-data" onsubmit="return FormValidate();" modelAttribute="product">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <form:input type="hidden" path="productId" class="form-control border-secondary" id="productName" name="productName"
                                            placeholder="Tên sản phẩm" />
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <form:textarea maxlength = "1000" path="shortDescription" name="address" id="shortDescription" 
                                ...
                                <div class="row py-3">
                                    <div class="form-group">
                                        <label for="longDescription">Mô tả chi tiết sản phẩm</label>
                                        <span class="text-danger">*</span>
                                        <form:textarea maxlength = "3000" path="longDescription" name="address" id="longDescription"
                            ...
                            <div class="col-md-5 text-center">
                                ...
                                <h3 class = "py-3">Thay ảnh mới</h3>
                                	<div class="row">
                                		<div class="button-wrap">
                                		    <label class="button" for="upload">Chọn 1 ảnh</label>
											<input id="upload" class = "mx-3" name = "productImageName" type="file" accept="image/*" onchange="loadFile(event)">
	...
	<script type="text/javascript" src="<c:url value="/sources/js/product.js" />"></script>
	<script>
